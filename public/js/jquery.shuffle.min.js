      ...
      ? n.randomize
        ...
        : (n.by !== t.noop &&
            ...
            s.sort(function (e, s) {
              ...
              return o === i && a === i
                ? ((r = !0), 0)
                : 'sortFirst' === o || 'sortLast' === a
                  ? -1
                  : 'sortLast' === o || 'sortFirst' === a
                    ? 1
                    : a > o
                      ? -1
                      : o > a
  ...
  ;((s.prototype = {
    ...
    _setVars: function () {
      ...
      return (
        ...
        'string' == typeof e.columnWidth
          ? (e.$sizer = e.$container.find(e.columnWidth))
          : e.columnWidth && e.columnWidth.nodeType && 1 === e.columnWidth.nodeType
            ? (e.$sizer = t(e.columnWidth))
            : e.columnWidth && e.columnWidth.jquery && (e.$sizer = e.columnWidth),
        e.$sizer && e.$sizer.length && ((e.useSizer = !0), (e.sizer = e.$sizer[0])),
        e
      )
    },
    ...
    _getPreciseDimension: function (e, i) {
      var n
      return (
        (n = window.getComputedStyle ? window.getComputedStyle(e, null)[i] : t(e).css(i)),
        parseFloat(n)
      )
    },
    _setColumns: function (t) {
      var e,
        ...
        s =
          'function' == typeof i.gutterWidth
            ? i.gutterWidth(n)
            : i.useSizer
              ? i._getPreciseDimension(i.sizer, 'marginLeft')
              : i.gutterWidth
      ;((i.colWidth = i.isFluid
        ? i.columnWidth(n)
        : i.useSizer
          ? i._getPreciseDimension(i.sizer, 'width')
          : i.columnWidth || i.$items.outerWidth(!0) || n),
        (i.colWidth = i.colWidth || n),
        (i.colWidth += s),
        (e = (n + s) / i.colWidth),
        Math.ceil(e) - e < 0.01 && (e = Math.ceil(e)),
        (i.cols = Math.floor(e)),
    ...
    _reLayout: function (t, e) {
      ...
      ;((t = t || i.filterEnd),
        i._resetCols(),
        i.keepSorted && i.lastSort
          ? i.sort(i.lastSort, !0, e)
          : i._layout(i.$items.filter('.filtered').get(), i.filterEnd, e))
    },
    _placeItem: function (t, e, i, n, s) {
      ...
      ;(n ? (p.skipTransition = !0) : ((p.opacity = 1), (p.callback = i)),
        s && (p.opacity = 0),
        r.styleQueue.push(p))
    },
    ...
    _onResize: function () {
      ...
      e.enabled &&
        !e.destroyed &&
        ((t = e.$container.width()), t !== e.containerWidth && e.resized())
    },
    ...
    transition: function (e) {
      var n,
        s = this,
        r = function () {
          s.layoutTransitionEnded || 'layout' !== e.from
            ? s.shrinkTransitionEnded ||
              'shrink' !== e.from ||
              (e.callback.call(s), (s.shrinkTransitionEnded = !0))
            : (s._fire('layout'), e.callback.call(s), (s.layoutTransitionEnded = !0))
        }
        ...
        (e.scale === i && (e.scale = 1),
          (n = s.threeD
            ? 'translate3d(' +
              ...
              e.scale +
              ', 1)'
            : 'translate(' + e.x + 'px, ' + e.y + 'px) scale(' + e.scale + ', ' + e.scale + ')'),
    ...
    _addItems: function (t, e, n) {
      ...
      ;(o.supported || (e = !1),
        ...
        o._updateItemCount(),
        e
          ? (o._layout(r, null, !0, !0), n && o._setSequentialDelay(s), o._revealAppended(s))
          : o._layout(r))
    },
    ...
    (t.fn.shuffle = function (e) {
      ...
      return this.each(function () {
        var n = t(this),
          r = n.data('shuffle')
        ;(r || ((r = new s(n, e)), n.data('shuffle', r)),
